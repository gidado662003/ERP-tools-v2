    ...
    <div className="min-h-screen bg-background">
      <div className="flex min-h-screen">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          {/* top bar */}
          <header className="sticky top-0 z-10 flex h-10 items-center justify-between  bg-background/80 px-4 backdrop-blur">
          ...
          <main className="min-w-0 flex-1 p-2 md:p-2 ">{children}</main>
        </div>
      </div>
    </div>
  );
